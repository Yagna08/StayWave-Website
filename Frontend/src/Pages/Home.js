...
const Home = () => {
  ...
  const getInitialWishlist = async () => {
    try {
      ...
      let getwishlist = await axios.post('/api/user/getwishlist', { userid })
  ...
  const wishlists = async (id) => {
    try {
      ...
      console.log(addid);
      console.log(userid);
      let res = await axios.post("/api/user/addwishlist", { userid, addid });
  ...
  const type = async (type) => {
    try {
      ...
      parameter["skip"] = 0;
      console.log(type);
      let res = await axios.post("/api/user/trial", parameter);
      if (res.data.success) {
  ...
  const skips = async () => {
    try {
      ...
      let res = await axios.post("/api/user/skips", parameter);
      // result=await result.json()
      if (res.data.success) {
        // console.log(res.data.data);
        // console.log(dot)
  ...
  const getUserData = async (values, parameter) => {
    ...
    console.log(parameter);
    try {
      const res = await axios.post("/api/user/getData", parameter);
      if (res.data.success) {
        // console.log(res.data.data);
        // console.log(dot)
        console.log(res.data.mainData);
